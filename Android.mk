...
LOCAL_SRC_FILES += $(call all-java-files-under, ../ThemePicker/src)
LOCAL_SRC_FILES += $(call all-java-files-under, ../ThemePicker/src_override)
...
LOCAL_AAPT_FLAGS := --auto-add-overlay \
    --extra-packages com.android.wallpaper
